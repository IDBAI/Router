...
import com.idba.compiler.Constants;
...
final class TargetClass {
    ...
    private static final ClassName PARAMETERS_INJECTOR = ClassName.get("com.idba.icore.InjectUtils", "ParametersInjector");
...
//        }
    ...
    private MethodSpec createInjectMethod(TypeName targetType) {
        ...
        for (FiledInjecting filed : filedInjectingList) {
            ...
            if (filed.getAnnotation().equals(InjectParams.class)) {
